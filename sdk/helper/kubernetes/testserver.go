...
// Kubernetes client code. It returns its current labels as a map
...
func TestServer(t *testing.T) (currentLabels map[string]string, closeFunc func()) {
	...
	return currentLabels, closeFunc
}
